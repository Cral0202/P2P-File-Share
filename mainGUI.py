...
"color: rgb(255, 255, 255);")
        ...
        self.enableNetworkingButton = QtWidgets.QPushButton(parent=self.layoutWidget)
        self.enableNetworkingButton.setStyleSheet("background-color: rgb(94, 94, 94);\n"
"color: rgb(255, 255, 255);")
        self.enableNetworkingButton.setObjectName("enableNetworkingButton")
        self.userIPHBox.addWidget(self.enableNetworkingButton)
        self.disableNetworkingButton = QtWidgets.QPushButton(parent=self.layoutWidget)
        self.disableNetworkingButton.setStyleSheet("background-color: rgb(94, 94, 94);\n"
"color: rgb(255, 255, 255);")
        self.disableNetworkingButton.setObjectName("disableNetworkingButton")
        self.userIPHBox.addWidget(self.disableNetworkingButton)
...
"color: rgb(255, 255, 255);")
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(30, 360, 307, 26))
...
"color: rgb(255, 255, 255);")
        ...
        self.networkingLabel = QtWidgets.QLabel(parent=self.centralwidget)
        self.networkingLabel.setGeometry(QtCore.QRect(10, 0, 501, 16))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.networkingLabel.sizePolicy().hasHeightForWidth())
        self.networkingLabel.setSizePolicy(sizePolicy)
        self.networkingLabel.setStyleSheet("color: rgb(255, 255, 255);")
        self.networkingLabel.setObjectName("networkingLabel")
        ...
        self.connectionLabel.setStyleSheet("color: rgb(255, 255, 255);")
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.enableNetworkingButton.setText(_translate("MainWindow", "Enable Networking"))
        self.disableNetworkingButton.setText(_translate("MainWindow", "Disable Networking"))
        ...
        self.networkingLabel.setText(_translate("MainWindow", "Networking disabled"))
